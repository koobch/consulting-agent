...
function testCreateSlides() {
  const sampleMarkdown = `## 국내 방치형 RPG 시장 분석
작성일: 2026.02.25 | 전략기획팀
...
## 국내 방치형 RPG 시장은 2026년 1.2조원 규모, YoY 18% 성장 전망

**레이아웃**: 제목+본문

- 2025년 시장 규모: **1.0조원** (전체 모바일 게임의 약 10%)
- 2026년 전망: **1.2조원** (YoY +18%)
- 성장 동인: 캐주얼 유저 유입, 하이브리드 수익화 모델

> 발표자 노트: 방치형 RPG는 낮은 진입 장벽과 높은 수익화 효율로 지속 성장 중

---

## 상위 5개 게임이 매출의 65%를 점유하는 과점 구조
...
> 발표자 노트: 상위 과점이지만, 신작 진입 시 빠르게 순위 변동이 일어나는 시장
`;
